...
<h3 align="center">Computer Network ระบบเครือข่ายคอมพิวเตอร์</h3>
...
<h2 style="text-indent: 2em; text-decoration: underline;">ความรู้ที่ฉันได้รับจากวิชานี้</h2>
1. ฉันสามารถเข้าใจหลักการรับ/ส่งข้อมูล และแยกแยะระหว่างข้อมูลแบบดิจิทัลและอนาล็อกว่ามีความแตกต่างกันอย่างไร ทำไมถึงต้องใช้คลื่นเข้ามาเป็นตัวกลางในการรับ/ส่งข้อมูล
<br>2. ทราบถึงการทำงานของมุมเฟสในแบบต่างๆ รวมถึงการแบ่งซีกของแต่ละแบบด้วย
<br>3. เข้าใจถึงปัญหาของการเกิด Delay ในการส่ง packet แต่ละครั้งว่าความหน่วงหรือดีเลย์ที่เกิดขึ้นมาจากอะไรได้บ้าง อีกทั้งยังสามารถคำนวณค่าได้คร่าวๆ เพื่อประเมิณศักยภาพของสัญญาณ ณ เวลานั้นว่ามีความเหมาะสมหรือไม่ ควรเปลี่ยนอุปกรณ์หรือเปล่า
<br>4. สามารถคำนวณการแบ่ง Subnet และวิธีเลือกใช้ IP address ให้กับแต่ละอุปกรณ์ที่เหมาะสมที่สุดได้
<a href="lab1.pkt"> LAB 1 </a>
<br>5. เข้าใจการทำงานของ Router และ Switch กรณีที่มีถึง 2 departments
<a href="lab2.pkt"> LAB 2 </a>
<br>6. สามารถสร้างโครงข่ายระดับองค์กร 2 สาขา(แบบย่อ) ที่สามารถเชื่อมหากันได้ โดยให้อุปกรณ์เรียนรู้เส้นทางหรือการ Routing และสามารถตรวจเช็คได้ด้วยการ ping
<a href="Ex3.pkt"> LAB 3 </a>
<br>7. สามารถสร้างโครงข่ายระดับองค์กร 3 สาขา(แบบย่อ) และสามารถเชื่อมหากันได้ระหว่าง 3 สาขา
<a href="ex4.pkt"> LAB 4 </a>
<br>8. เข้าใจปัญหาของ Hub ทำให้เกิดการชนกันหรือ Collision Domain อีกทั้งยังสามารถแก้ไขปัญหาได้ด้วยการทำ VLan และ Trunk บน switch
<a href="ex5.pkt"> LAB 5 </a>
<br>9. สามารถออกแบบระบบให้อุปกรณ์เรียนรู้เส้นทางแบบ Dynamic Routing พร้อมทั้งเชื่อมหากันได้ระหว่าง 3 สาขา
<a href="ex6.pkt"> LAB 6 </a>

<h2 style="text-indent: 2em; text-decoration: underline;">⭐ สกิลที่ได้รับหลังจากผ่านวิชานี้</h2>
1. กอล์ฟสามารถเลือกใช้สายไฟกับระหว่างอุปกรณ์ 2 ตัว ได้อย่างถูกต้อง ว่ากรณีไหนต้องใช้สายตรง กรณีไหนต้องใช้สาย cross เพื่อให้ระบบทำงานได้อย่างถูกต้อง
<br>2. กอล์ฟสามารถออกแบบระบบเน็ตเวิร์กเบี้องต้นได้ รวมถึงการแบ่ง Subnet ให้มีจำนวนเหมาะสมกับแต่ละ Department จนถึงระดับองค์กรมากถึง 5 สาขา ภายใน IP เดียว พร้อมทั้งการเซ็ตค่าอุปกรณ์ไม่ว่าจะเป็นชื่อ, IP address, VLan, Trunk, Static Routing พร้อมทั้งเชื่อมหากัน(Ping) ภายในระหว่าง 5 สาขาได้สำเร็จ
<a href="EXex.pkt"> LAB Pretest </a>
<br>3. ถึงแม้กอล์ฟยังไม่เคยต่อสายเน็ตเวิร์กจริง แต่สามารถทำความเข้าใจได้ไม่ยาก เพราะโปรแกรมที่ใช้ฝึกนั้น รองรับระบบกายภาพเสมือนจริง
<br>
<br>
