...
1. ฉันสามารถเข้าใจหลักการรับ/ส่งข้อมูล แยกแยะระหว่างข้อมูลแบบดิจิทัลและอนาล็อกว่ามีความแตกต่างกันอย่างไร ทำไมถึงต้องใช้คลื่นเข้ามาเป็นตัวกลางในการรับ/ส่งข้อมูล
<br>2. ทราบถึงการทำงานของมุมเฟสในแบบต่างๆ รวมถึงการแบ่งซีกของแต่ละแบบด้วย
<br>3. เข้าใจถึงปัญหาของการเกิด Delay ในการส่ง packet แต่ละครั้งว่าความหน่วงหรือดีเลย์ที่เกิดขึ้นมาจากอะไรได้บ้าง อีกทั้งยังสามารถคำนวณค่าได้คร่าวๆ เพื่อประเมินศักยภาพของสัญญาณ ณ เวลานั้นว่ามีความเหมาะสมหรือไม่ ควรเปลี่ยนอุปกรณ์หรือเปล่า
<br>4. สามารถคำนวณการแบ่ง Subnet และวิธีเลือกใช้ IP address กับแต่ละอุปกรณ์ให้เหมาะสมที่สุดได้
<a href="lab1.pkt"> LAB 1 </a>
<br>5. เข้าใจการทำงานของ Router และ Switch กรณีที่มีถึง 2 departments
<a href="lab2.pkt"> LAB 2 </a>
<br>6. สามารถสร้างโครงข่ายระดับองค์กร 2 สาขา(แบบย่อ) ที่สามารถเชื่อมหากันได้ โดยให้อุปกรณ์เรียนรู้เส้นทางหรือการ Static Routing และสามารถตรวจเช็คได้ด้วยการ ping
